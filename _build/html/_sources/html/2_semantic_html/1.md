...
## 1.1. Why should you care about semantic HTML?
...
## 1.2. Why is it important to have good structural hierarchy?
...
## 1.3. What is the difference between presentational and semantic HTML?
...
## 1.4. When should you use the emphasis element over the idiomatic text element?
...
## 1.5. When should you use the <code>strong</code> elements over the bring attention to element, <code>b</code>?
...
## 1.6. What are description lists, and when should you use them?
...
## 1.7. How do you block and inline quotes work in HTML?
...
## 1.8. How do you display abbreviations and acronyms in HTML?
...
## 1.9. How do you display addresses in HTML?
...
## 1.10. How do you display times and dates in HTML?
...
## 1.11. How do you display mathematical equations and chemical formulas in HTML?
...
## 1.12. How do you represent computer code in HTML?
...
## 1.13.  What are the <code>u</code>, <code>s</code>, and <code>ruby</code> elements used for?
